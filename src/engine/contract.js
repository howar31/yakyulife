...
import {R, ri, pick, chance, clamp, SEED} from '../core/rng.js?v=1.5.5';
import {LV, PATHS, CPBL_TEAMS, NPB_TEAMS, MLB_TEAMS} from '../data/teams.js?v=1.5.5';
import {AMA_ANNUAL, LEVEL_MIN_ANNUAL, MLB_SERVICE_MINOR_MIN} from '../data/economy.js?v=1.5.5';
...
import {injuryMarketStatus} from './injury.js?v=1.5.5';
import {hasActiveFranchise} from './tenure.js?v=1.5.5';
import {seasonSalaryRating, currentSalaryRating} from './season.js?v=1.5.5';
import {capTeam} from './career.js?v=1.5.5';
import {traitCard, removeTrait} from '../flow/events.js?v=1.5.5';
import {advance} from './draft.js?v=1.5.5';
import {finishContractYear} from '../flow/phases.js?v=1.5.5';
