...
import {TRAIT_KEYS, TRAIT_N, TRAIT_FX, legendTraitNames, pitcherTCNames, hitterTCNames} from '../data/traits.js?v=1.5.4';
import {TEAM_COLOR, teamNick} from '../data/teams.js?v=1.5.4';
