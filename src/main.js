import {SEED, setSeed, seedInit} from './core/rng.js?v=1.5.5';
import {S, setS, newState} from './core/state.js?v=1.5.5';
import {APP_VER} from './config.js?v=1.5.5';
import {POSN} from './data/abilities.js?v=1.5.5';
import {LV} from './data/teams.js?v=1.5.5';
import {$, card, modalClose, actToggleSync} from './ui/dom.js?v=1.5.5';
import {THEME_KEY, BIG_KEY, applyTheme, applyMobileUI, applyBigText, updDispSum} from './ui/prefs.js?v=1.5.5';
import {allocFullClose} from './ui/alloc.js?v=1.5.5';
import {TL, resetTL, renderTimeline, tlScrollTo} from './ui/timeline.js?v=1.5.5';
import {startYear} from './flow/phases.js?v=1.5.5';
